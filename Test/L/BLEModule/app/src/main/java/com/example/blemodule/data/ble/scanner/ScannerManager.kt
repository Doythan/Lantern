package com.example.blemodule.data.ble.scanner
...
import com.example.blemodule.data.ble.gatt.GattClientManager
        ...
        scanCallback = object : ScanCallback() {
            override fun onScanResult(callbackType: Int, result: ScanResult?) {
                ...
                result?.let { scanResult ->
                            val deviceName = if (ContextCompat.checkSelfPermission(activity, android.Manifest.permission.BLUETOOTH_CONNECT)
