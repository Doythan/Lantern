...
object AppDestinations {
    ...
    const val DIRECT_CHAT_ROUTE = "direct_chat"
...
fun AppNavigation(
    ...
    // Chat ViewModel은 채팅 화면들 간에 공유되어야 합니다
    ...
    NavHost(
        ...
        composable(AppDestinations.HOME_ROUTE) {
            // HomeScreen이 구현되지 않은 경우 PublicChatScreen으로 대체
            PublicChatScreen(navController = navController, viewModel = chatViewModel)
        }
        ...
        composable(AppDestinations.DIRECT_CHAT_ROUTE) {
            DirectChatScreen(navController = navController, viewModel = chatViewModel)
        }
