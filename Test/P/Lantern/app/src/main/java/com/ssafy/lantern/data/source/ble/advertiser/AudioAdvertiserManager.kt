...
class AudioAdvertiserManager(private val activity: Activity) {
    ...
    fun stopAdvertising() {
        ...
        val adv = advertiser
        if (adv == null || ContextCompat.checkSelfPermission(activity, Manifest.permission.BLUETOOTH_ADVERTISE) != PackageManager.PERMISSION_GRANTED) {
            advertising = false
            callback = null
            retryCount = 0
            return
